---
title: Variants Images Widget
description: A Medusa admin widget for managing variant-specific images and thumbnails
author: Reedrinc
---
...
# Variants Images Widget by Reedrinc

The Variants Images Widget, developed by Reedrinc, is a custom widget for the Medusa admin panel that enables managing variant-specific images and thumbnails for products.
...
- GitHub: [reedrinc/medusa-admin-variants-images-widget](https://github.com/reedrinc/medusa-admin-variants-images-widget)
- Email: support@reedrinc.com
