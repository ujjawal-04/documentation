---
title: "ViewImagesModal Component"
description: "A modal component for viewing variant images and thumbnails."
---
...
## ViewImagesModal Component

The `ViewImagesModal` component provides a modal (drawer) interface for displaying a product variant's thumbnail and additional images.

### Props

| Prop             | Type                         | Description                                     |
|-----------------|----------------------------|-------------------------------------------------|
| `variantThumbnail` | `string | undefined`        | URL of the variant's thumbnail image.           |
| `variantImages` | `VariantImage[]`            | Array of additional images for the variant.     |

### Usage

```tsx
<ViewImagesModal 
  variantThumbnail="https://example.com/thumbnail.jpg"
  variantImages={[
